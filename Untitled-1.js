...
//                 <p className="card-description">Products Info</p>
//                 <div className="row">
...
const SKURegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const IDSKURegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const VendorProductIDRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const ProductNameRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const ProductDescriptionRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const SupplierIDRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const CategoryIDRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const QuantityPerUnitRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const UnitPriceRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const MSRPRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const AvailableSizeRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const AvailableColorRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const SizeRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const ColorRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const DiscountRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const AvailableDiscountRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const UnitWeightRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const UnitsInStockRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const UnitsOnOrderRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const ReorderLevelRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const ProductAvailableRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const DiscountAvailableRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const CurrentOrderRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const PictureRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const LinkingRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
const NoteRegex = RegExp(/^([a-zA-Z0-9 ]{2,10})$/);
